(function(d){var a=window.NotifierjsConfig={defaultTimeOut:5E3,position:["bottom","right"],notificationStyles:{padding:"12px 18px",margin:"0 0 6px 0",backgroundColor:"#000",opacity:0.8,color:"#fff",font:"normal 13px 'Droid Sans', sans-serif",borderRadius:"3px",boxShadow:"#999 0 0 12px",width:"300px"},notificationStylesHover:{opacity:1,boxShadow:"#000 0 0 12px"},container:d("<div></div>")};d(document).ready(function(){a.container.css("position","absolute");a.container.css("z-index",9999);a.container.css(a.position[0],
