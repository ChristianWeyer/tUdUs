/**
 * Javascript functions to show notification
 * Error/Success/Info/Warning messages
 * based on: Developed By: Ravi Tamada
...
function showNotification(params) {
    ...
    slideNotification(options['showAfter'], options['autoClose'], options['duration']);
...
// sliding the notification
function slideNotification(startAfter, autoClose, duration) {
    setTimeout(function () {
        $('div#info_message').animate({
            bottom: 47
        });
