...
todosApp.load = function () {
    $.when(ttTools.templateLoader.loadExternalTemplate("www/templates/tasksList.tmpl.html"),
               ttTools.templateLoader.loadExternalTemplate("www/templates/idpList.tmpl.html"),
               ttTools.templateLoader.loadExternalTemplate("www/templates/pictureGallery.tmpl.html"))
            .then(
                function () {
                    todosApp.init();
                },
